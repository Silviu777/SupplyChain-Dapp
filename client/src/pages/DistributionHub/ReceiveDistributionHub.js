...
export default function ReceiveDistributionHub(props) {
    ...
    const handleReceiveButton = async (id, long, lat) => {
        try {
            ...
            console.log("Using distribution hub address:", roles.distributionHub);
            await supplyChainContract.methods
                .receiveByDistributionHub(id, long, lat)
